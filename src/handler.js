...
const addBookHandler = (request, h) => {
  ...
  // fungsi jika readPage lebih besar dari pada pageCount
...
const getAllBookHandler = (request, h) => {
  ...
  // jika finished = undefined / kosong
  if (finished === '0') {
...
const getBookByIdHandler = (request, h) => {
  ...
  const book = books.filter((bu) => bu.id === bookId)[0];
